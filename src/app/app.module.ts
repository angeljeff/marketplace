...
import { SeccionProyeccionAdministradorComponent } from './paginas/usuario-administrador/seccion-proyeccion-administrador/seccion-proyeccion-administrador.component';
...
@NgModule({
  declarations: [
    ...
    SeccionProyeccionAdministradorComponent,
