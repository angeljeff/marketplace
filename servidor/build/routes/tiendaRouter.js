...
class TiendaRoutes {
    ...
    config() {
        ...
        this.router.post('/obtener/:id_tienda', tiendaController_1.default.obtenerPorid);
        ...
        this.router.put('/contador/:id_tienda', tiendaController_1.default.actualizar_contador);
