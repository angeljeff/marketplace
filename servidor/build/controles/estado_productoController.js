...
class EstadoproductoController {
    listar_estados(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const lista_estados = yield base_datos_1.default.query('SELECT * FROM estado_productos');
    ...
    obtenerPorid(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const estad = yield base_datos_1.default.query(`SELECT * FROM estado_productos where id_estado_pro ='${estado}'`);
            res.send(estad);
        });
    }
}
