...
class OrdencompraController {
    ...
    const agrega_pro = await pool.query("UPDATE orden_compra SET  total = ?, direccion= ?, celular= ?, fecha_orden= ?, nombres= ?, cedula_envio= ?, id_metodo_pago_tienda = ?, id_estado_pedido = ? WHERE id_orden_compra = ?",
    [req.body.total, req.body.direccion ,req.body.celular,req.body.fecha_orden, req.body.nombres,req.body.cedula_envio,req.body.id_metodo_pago_tienda, req.body.id_estado_pedido, req.params.id_orden_compra]);
